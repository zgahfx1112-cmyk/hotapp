...
<meta property="og:description" content="来自${safeSource || '今日热榜'}的热门资讯">
...
<div class="card-body">
<span class="card-source">${safeSource || '今日热榜'}</span>
...
<script>setTimeout(function(){location.href="${safeUrl}";},3000);</script>
</body>
</html>`);
});
